...
def rerenders(img_path, proc_param, joints, verts, cam, folder_name):
    ...
    cv2.imwrite("frames/FRAMES_HMR/" + folder_name + "/" + img_path.split('/')[-1][:-4]+".png",rend_img_overlay)
...
def visualize(img_path, img, proc_param, joints, verts, cam, folder_name):
    ...
    cv2.imwrite(cur_path1 + "/frames/FRAMES_HMR/"+ folder_name + '/' + img_path.split('/')[-1][:-4]+".png",rend_img_overlay)
...
def main(img_path, json_path=None):
    ...
    with open(cur_path1 + "/frames/FRAMES_PICKLE/"+ img_path.split('/')[-2] + '/' + img_path.split('/')[-1][:-4]+".pkl", 'wb') as f:
