...
def rerenders(img_path, proc_param, joints, verts, cam):
    try:
    ...
    cv2.imwrite("/home/ank99/Desktop/GUI_project/test_img/"+ img_path.split('/')[-1][:-4]+".png",rend_img_overlay)
...
def main(img_path, json_path=None):
    ...
    with open("/home/ank99/Desktop/GUI_project/test_params/"+ img_path.split('/')[-1][:-4]+".pkl", 'wb') as f:
