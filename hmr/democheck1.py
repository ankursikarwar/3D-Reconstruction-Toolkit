...
# def rerenders_save(img_path, proc_param, joints, verts, pose, shape, cam, folder_name):
#     try:
#         import hmr.src.config
#         from hmr.src.util import renderer as vis_util
...
#     params = {'proc_param': proc_param, 'joints': joints[0], 'cam': cam[0], 'pose': pose, 'shape': shape}
