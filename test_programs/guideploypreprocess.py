...
def run_hmr(video_path, frame_number, hmr_params_path, flag=False):
    ...
    if (not(os.path.isfile(hmr_params_path))) or (flag == True):
        print("Running HMR on frame : ", frame_number)
        frame_path = video_path + str(frame_number) + ".png"
        cur_path = os.getcwd()
        ...
        os.chdir(cur_path)
        if flag == False:
            hmr_params_path_save = video_hmr_save_pickle + str(frame_number) + ".pkl" 
            hmr_frame_path_save = video_hmr_save + str(frame_number) + ".png"
            hmr_params_path = video_hmr_pickle + str(frame_number) + ".pkl"
            hmr_frame_path = video_path_hmr + str(frame_number) + ".png"
