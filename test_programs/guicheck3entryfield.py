...
from hmr.democheck1 import rerenders_save
...
def getVal():
    ...
    rerenders_save(frame_path, proc_param, joints, verts, pose, shape, cam, folder_name)
    cur_path = os.getcwd()
...
def imp_vid():
    ...
    vid_path = ifile.name
    print(vid_path)
    if not os.path.exists('/home/ankur/GUI_project/frames/FRAMES_WITHOUT_HMR/'+vid_path.split('/')[-1][:-4]):
         os.makedirs('/home/ankur/GUI_project/frames/FRAMES_WITHOUT_HMR/'+vid_path.split('/')[-1][:-4])
    if not os.path.exists('/home/ankur/GUI_project/frames/FRAMES_HMR/'+vid_path.split('/')[-1][:-4]):
         os.makedirs('/home/ankur/GUI_project/frames/FRAMES_HMR/'+vid_path.split('/')[-1][:-4])
    if not os.path.exists('/home/ankur/GUI_project/frames/FRAMES_PICKLE/'+vid_path.split('/')[-1][:-4]):
         os.makedirs('/home/ankur/GUI_project/frames/FRAMES_PICKLE/'+vid_path.split('/')[-1][:-4])

    video_path = '/home/ankur/GUI_project/frames/FRAMES_WITHOUT_HMR/' +vid_path.split('/')[-1][:-4] + '/'
    video_path_hmr = '/home/ankur/GUI_project/frames/FRAMES_HMR/' +vid_path.split('/')[-1][:-4] + '/'
    video_hmr_pickle = '/home/ankur/GUI_project/frames/FRAMES_PICKLE/' +vid_path.split('/')[-1][:-4] + '/'
    print(video_path)
...
def load_first():
    ...
    cur_path = os.getcwd()
    os.chdir(hmr_path)
    cmd = "python -m democheck1 --img_path " + frame_path
    print cmd    
    os.system(cmd)
    print "hello"
    os.chdir(cur_path)
...
frame_count_variable = StringVar() 
label_framecount = Label(rightframe, textvariable=frame_count_variable)
label_framecount.pack(side=BOTTOM)
