...
def load_first():
    global frame_count, total_frames, video_path, video_path_hmr, video_hmr_pickle, total_frames
...
def run_hmr_allframes():
    global total_frames, video_hmr_pickle, video_path 
    frame_count = 1
...
runhmr.pack()
runhmr_all = Button(bottomframe, text = 'Run HMR on all frames', fg = 'black', command=run_hmr_allframes)
runhmr_all.pack()
