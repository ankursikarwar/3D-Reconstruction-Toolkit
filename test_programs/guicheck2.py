...
def imp_vid():
    ...
    vid_path = ifile.name
    print(vid_path)
    if not os.path.exists('/home/ank99/Desktop/GUI_project/frames/FRAMES_WITHOUT_HMR/'+vid_path.split('/')[-1][:-4]):
         os.makedirs('/home/ank99/Desktop/GUI_project/frames/FRAMES_WITHOUT_HMR/'+vid_path.split('/')[-1][:-4])
    if not os.path.exists('/home/ank99/Desktop/GUI_project/frames/FRAMES_HMR/'+vid_path.split('/')[-1][:-4]):
         os.makedirs('/home/ank99/Desktop/GUI_project/frames/FRAMES_HMR/'+vid_path.split('/')[-1][:-4])
    if not os.path.exists('/home/ank99/Desktop/GUI_project/frames/FRAMES_PICKLE/'+vid_path.split('/')[-1][:-4]):
         os.makedirs('/home/ank99/Desktop/GUI_project/frames/FRAMES_PICKLE/'+vid_path.split('/')[-1][:-4])

    video_path = '/home/ank99/Desktop/GUI_project/frames/FRAMES_WITHOUT_HMR/' +vid_path.split('/')[-1][:-4] + '/'
    video_path_hmr = '/home/ank99/Desktop/GUI_project/frames/FRAMES_HMR/' +vid_path.split('/')[-1][:-4] + '/'
    video_hmr_pickle = '/home/ank99/Desktop/GUI_project/frames/FRAMES_PICKLE/' +vid_path.split('/')[-1][:-4] + '/'
    print(video_path)
    print(video_path_hmr)
    print(video_hmr_pickle)
    cmd = "cp " + vid_path + " /home/ank99/Desktop/newfolder/keras_Realtime_Multi-Person_Pose_Estimation/sample_videos/Dance1.webm"
    print(cmd)
    os.system(cmd)
    os.chdir("/home/ank99/Desktop/newfolder/")
    print(os.getcwd())
    cmd = "./com.sh"
    os.system(cmd)
    os.remove('/home/ank99/Desktop/newfolder/keras_Realtime_Multi-Person_Pose_Estimation/sample_videos/Dance1.webm')
    d = '/home/ank99/Desktop/newfolder/keras_Realtime_Multi-Person_Pose_Estimation/sample_jsons'
    filesToRemove = [os.path.join(d,f) for f in os.listdir(d)]
    for f in filesToRemove:
        os.remove(f)
    source1 = '/home/ank99/Desktop/newfolder/keras_Realtime_Multi-Person_Pose_Estimation/sample_images/'
    dest1 = '/home/ank99/Desktop/GUI_project/frames/FRAMES_WITHOUT_HMR/' +vid_path.split('/')[-1][:-4]
    files1 = os.listdir(source1)
    for f in files1:
        shutil.move(source1+f,dest1)
    source2 = '/home/ank99/Desktop/newfolder/hmr/output/images/overlay/'
    dest2 = '/home/ank99/Desktop/GUI_project/frames/FRAMES_HMR/' +vid_path.split('/')[-1][:-4]
    files2 = os.listdir(source2)
    for f in files2:
        shutil.move(source2+f,dest2)
    os.chdir("/home/ank99/Desktop/GUI_project")
    load_first()
...
def load_first():
    ...
    im_path = video_path_hmr + str(frame_count) + ".png"
...
def next_frame():
    ...
    print(frame_count)
    # print(total_frames)
    frame_path = video_path_hmr + str(frame_count) + ".png"
